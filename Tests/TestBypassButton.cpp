...
{
public:
    // Registered under the "Boostor" category so boostor's test main
    // (runTestsInCategory("Boostor")) picks it up alongside GainTest.
    BypassButtonMetricsTests() : juce::UnitTest("BypassButtonMetrics", "Boostor") {}
